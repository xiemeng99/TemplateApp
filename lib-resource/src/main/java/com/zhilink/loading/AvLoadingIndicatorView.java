...
import com.zhilink.reasourselibrary.R;

/**
 * copy from https://github.com/81813780/AVLoadingIndicatorView
 *
 * @author xiemeng
 * @date 2018-10-24
 */
public class AvLoadingIndicatorView extends View {
    ...
    private static final int MIN_SHOW_TIME = 500*2;
    private static final int MIN_DELAY = 500*2;
