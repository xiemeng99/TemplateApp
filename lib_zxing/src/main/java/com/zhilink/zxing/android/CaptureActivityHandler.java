...
public final class CaptureActivityHandler extends Handler {
    ...
    public CaptureActivityHandler(Activity activity,
        ...
        decodeThread = new DecodeThread(activity, listener, decodeFormats, baseHints, characterSet,
                new ViewfinderResultPointCallback(listener.getViewfinderView()));
        decodeThread.start();
        state = State.SUCCESS;
    ...
    public void handleMessage(Message message) {
        if (message.what == R.id.restart_preview) {
            ...
            listener.handleDecode((Result) message.obj, barcode, scaleFactor);
